...
def main():
    ...
    parser.add_argument('tracker_name', type=str, help='transT')
    parser.add_argument('tracker_param', type=str, help='Name of parameter file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='otb', help='OTB')
    parser.add_argument('--sequence', type=str, default=None, help='Basketball')
    parser.add_argument('--debug', type=int, default=0, help='Debug level.')
    parser.add_argument('--threads', type=int, default=0, help='1')
