...
def run(settings):
    ...
    settings.search_feature_sz = 32  # 搜索图像特征图大小
    settings.template_feature_sz = 16  # 模板图像特征图大小
    settings.search_sz = settings.search_feature_sz * 8  # 搜索图像大小 stride 8
    settings.temp_sz = settings.template_feature_sz * 8  # 模板图像大小 stride 8
    settings.center_jitter_factor = {'search': 3, 'template': 0}  # 中心平移
    settings.scale_jitter_factor = {'search': 0.25, 'template': 0}  # 尺度变化
