...
parser.add_argument('--name', default='res/', type=str,
...
def main():
    ...
    dataset_root = '/home/yan/data/OTB100' #Absolute path of the dataset
    net_path = '/home/yan/tracking/TransT/pytracking/networks/transt.pth' #Absolute path of the model
    ...
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019']:
        ...
        for v_idx, video in enumerate(dataset):
            ...
            if 'VOT2018-LT' == args.dataset:
                ...
                # 这里多加了一级目录'pysot_toolkit'，虽然不知道为什么，按理说应该生成在同一目录下
                model_path = os.path.join('pysot_toolkit', 'results', args.dataset, model_name)
